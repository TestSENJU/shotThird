...
public class MyScrollBarThinUI extends BasicScrollBarUI{
	public MyScrollBarThinUI(){
		super();
		//this.
	}
    ...
    protected void paintTrack(Graphics g, JComponent c, Rectangle trackBounds) {
           ...
           g2.setRenderingHint(RenderingHints.KEY_ANTIALIASING,
                   RenderingHints.VALUE_ANTIALIAS_ON);
               backgroupRectPaint = new GradientPaint(0, 0,MyColor.WHITE.getColor(),
                       trackBounds.width, 0,MyColor.WHITE.getColor());
           g2.setPaint(backgroupRectPaint);
           g2.fillRect(trackBounds.x, trackBounds.y, trackBounds.width, trackBounds.height);
           
           g2.setColor(MyColor.WHITE.getColor());
        ...
        return new BasicArrowButton(orientation) {
            ...
            public void paint(Graphics g) {
                ...
                if (scrollbar.getOrientation() == JScrollBar.VERTICAL) {
                    backgroupRectPaint = new GradientPaint(0, 0,  MyColor.WHITE.getColor(),
                            getWidth(), 0,  MyColor.WHITE.getColor());
                } else {
                    backgroupRectPaint = new GradientPaint(0, 0,  MyColor.WHITE.getColor(),
                            0, getHeight(),  MyColor.WHITE.getColor());
                }
                Graphics2D g2 = (Graphics2D) g;
                g2.setPaint(backgroupRectPaint);
                ...
                // Draw the arrow
                MyScrollBarThinUI.this.paintTriangle(g2, getSize(), direction);
            }
        };
    }
