...
public class TeamNumberAveragePanel extends JPanel{
	...
	public TeamNumberAveragePanel(String teamname){
		this.name=teamname;
		num=bl.getTeamAverageNumber(this.name, "2014-2015", 1);
		...
		choose.addMouseListener(new MouseAdapter(){
			public void mouseClicked(MouseEvent e){
				TeamNumberVO newNumber=bl.getTeamAverageNumber(name, (String)season.getSelectedItem(), after.getSelectedIndex());
