...
public class PlayerMatchDataPO {
	String gameID;
	String teamID;
	String teamName;
	String playerID;
	...
	public PlayerMatchDataPO(String gameID, String teamID, String teamName,
			String playerID, String playerName, String position, String MIN,
